        ...
        [
            {
                ...
                "url": "https://uapi.flashparking.cn/v1/member/getMemberInfo",
                "method": "post",
                "data": "mId=$mId&accesstoken=$c_token",
                "validate": "[{'eq': [{'returncode': 0}]}]",
                "relevance": "[{'plateNumber': \"['responsebody']['list'][0]['parkCode']['plateNumber']\"}]",
                "variables_data": ["mId", "c_token"],
                "variables": "[{'login_case_001': ['mId', 'c_token']}]",
            },
            "获取会员信息",
        ],
        [
            {
                ...
                "method": "post",
                "data": "mid=$mId&page=1&pageSize=1000",
                "validate": "[{'eq': [{'returncode': 0}]}]",
                "relevance": "[{'plateNumber': \"['responsebody']['list'][0]['parkCode']['plateNumber']\"}]",
                "variables_data": ["mId"],
                "variables": "[{'login_case_001': ['mId']}]",
            },
            "长租卡列表",
        ],
    ]
